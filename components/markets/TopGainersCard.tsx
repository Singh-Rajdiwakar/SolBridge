...
export function TopGainersCard({
  ...
  return (
    <div className="glass-panel border-emerald-400/12 p-5">
      <div className="text-[11px] uppercase tracking-[0.18em] text-slate-500">Top Gainers</div>
      <div className="mt-2 text-xl font-semibold text-white">Strongest 24h performers</div>
